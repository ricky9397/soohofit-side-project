...
<head>
    ...
    <%--    <link rel="icon" type="image/png" href="<c:url value="/resources/static/assets/images/icons/favicon.png"/>">--%>
    <!--===============================================================================================-->
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="javascript:(0)">All Products</a></li>
                                <li><a href="javascript:(0)">Women</a></li>
                                <li><a href="javascript:(0)">Men</a></li>
                                <li><a href="javascript:(0)">Bag</a></li>
                                <li><a href="javascript:(0)">Shoes</a></li>
                                <li><a href="javascript:(0)">Watches</a></li>
                            </ul>
                        </li>
