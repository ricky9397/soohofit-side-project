    ...
    <div id="loginBox">
        ...
        <div id="inputBox">
            <form name="frm" id="frm" action="" method="post" target="_self">
                <div class="input-form-box"><span>아이디 </span><input type="text" id="userId" name="userId"
                                                                    class="form-control"></div>
                <div class="input-form-box"><span>비밀번호 </span><input type="password" id="userPwd" name="userPwd"
                                                                     class="form-control"></div>
                <div>
                ...
                <div class="button-login-box">
                    <button type="button" class="btn btn-primary btn-xs" style="width:100%" onclick="goLogin();">로그인
                    </button>
                </div>
                <div class="button-login-box">
